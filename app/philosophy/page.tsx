    ...
    <div ref={scrollContainerRef} className="w-full min-h-screen">
      ...
      <section className="relative w-full h-screen flex items-center justify-center px-6 md:px-12 overflow-hidden">
        ...
        >
          ...
          >
            Our philosophy is transparent. We believe in creating visually
            stunning experiences that respect the viewer&apos;s intelligence and
            emotional depth.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                At Nature Guru Creations, we don&apos;t just create visual effects—we
                sculpt experiences. Every pixel, every frame, every moment is
              ...
              <p
                ...
                style={{ color: "rgba(29, 29, 31, 0.8)" }}
              >
                We believe that great VFX should feel organic, as if nature
                itself conspired to create the impossible. Our work bridges the
                gap between technical mastery and emotional storytelling.
              </p>
              <p
                className="text-lg leading-relaxed"
                style={{ color: "rgba(29, 29, 31, 0.8)" }}
              >
                Transparency is our foundation. We show our work, share our
                process, and mentor the next generation of creators who will
                shape tomorrow&apos;s visual culture.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <p
              ...
              style={{ color: "rgba(29, 29, 31, 0.7)" }}
            >
              Join us on a journey where art meets technology, and imagination
              becomes reality.
            </p>
            <motion.button
